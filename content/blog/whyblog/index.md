+++
title = "Why I decided to start an actual blog"
description = "The post that should've been the first lol"
date = 2025-12-22
...
<details> <summary>Click this to see an image of where this is in the YouTube embed</summary>
{{image(url="yt speed.png" alt="The settings menu as seen in the YouTube embed with 4 options: Stable Volume, Subtitles/CC, Playback speed, and Quality. Playback speed has a red outline around it, and is set to 0.8")}}
</details>

{{youtube(id="Ua0_JA4xQQg")}}
</details>

When I remade my website, one of the biggest reasons for this was so that I could start a proper blog in the same place as my personal space on the internet. It was a wish mainly inspired by many of the websites that I had seen on the indie web (and especially [Daudix's website](https://daudix.one)) that followed the same practice. As I had stated on the page for [The Patch Notes](@/projects/patch-notes/index.md), I had already been doing that in some capacity on that public Logseq graph.
