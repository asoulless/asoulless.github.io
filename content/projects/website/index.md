...
[extra]
accent_color = "#735187"
accent_color_dark = "#e0b8f5"

banner = "banner.png"
+++

<div class="buttons">
  <a>Check out the websi- <small>wait...</small></a>
...
- <a class="external" href="https://daudix.one/">Daudix</a>, of course, for the Duckquill theme
- <a class="external" href="https://mambuco.dev/">Mambuco</a>, actually, whose site I used as a bit of a reference for mine, especially for the [about me](@/about-me.md) page and the masonry layout. I ~~copied~~ referenced the source code for his and Daudix's websites for that page.
- <a class="external" href="https://iniox.github.io/">InioX</a> for <a class="external" href="https://github.com/InioX/matugen/">Matugen</a>, which I used for the accent colors used across various pages on this website.